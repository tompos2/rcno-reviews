...
class CSSTidy {
	 ...
	 * @param bool   $externalcss when printing formatted, indicates whether styles to be attached internally or as an
	 *                            external stylesheet
	 ...
	 *
	 * @param string $content   either filename (if $from_file == true), content of a template file,
	 *                          "high_compression", "highest_compression", "low_compression", or "default"

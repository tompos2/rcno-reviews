    ...
    <div class="review-score-options" style="width:25%; display:inline-block">
        ...
        <div class="review-score-rating-type">
            ...
            <select id="rcno_review_score_type" name="rcno_review_score_type">
                <option value="number" <?php if ( $review_score_type === 'number' ) {
					echo 'selected="selected"';
				} ?>>Number
                </option>
                <option value="letter" <?php if ( $review_score_type === 'letter' ) {
					echo 'selected="selected"';
				} ?>>Letter Grade
                </option>
                <option value="stars" <?php if ( $review_score_type === 'stars' ) {
					echo 'selected="selected"';
				} ?>>Stars
                </option>
            </select>
        ...
        <div class="review-score-rating-position">
            ...
            <select id="rcno_review_score_position" name="rcno_review_score_position">
                <option value="top" <?php if ( $review_score_position === 'top' ) {
					echo 'selected="selected"';
				} ?>>Top
                </option>
                <option value="bottom" <?php if ( $review_score_position === 'bottom' ) {
					echo 'selected="selected"';
				} ?>>Bottom
                </option>
            </select>

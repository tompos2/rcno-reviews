...
<div id="rcno-modal-wrap-scr" class="wp-core-ui search-panel-visible" style="display: none">
	<form id="rcno-modal-form-scr" tabindex="-1">
		...
		<div id="rcno-modal-title-scr">
			...
			<button type="button" id="rcno-modal-close-scr"><span class="screen-reader-text"><?php _e( 'Close' ); ?></span></button>
		</div>
		...
		<div class="submitbox">
			...
			<div id="rcno-modal-update-scr">
				<input type="submit" value="<?php esc_attr_e( 'Include Shortcut', 'rcno-reviews' ); ?>" class="button button-primary" id="rcno-modal-submit-scr" name="rcno-link-submit">
			</div>
		</div>
	</form>
</div>
    ...
    <div class="book-general-metabox-1">
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_publisher' ) ) : ?>
            <div class="book-title">
                ...
                <label class="rcno_book_title_label"
                       for="rcno_book_title"><?php _e( 'Title', 'rcno-reviews' ) ?></label>
                <input type="text" name="rcno_book_title" id="rcno_book_title"
                       value="<?php echo sanitize_text_field( $book_title ); ?>"/>
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_publisher' ) ) : ?>
            <div class="publisher-info">
                ...
                <label class="rcno_book_publisher_label"
                       for="rcno_book_publisher"><?php _e( 'Publisher', 'rcno-reviews' ) ?></label>
                <input type="text" name="rcno_book_publisher" id="rcno_book_publisher" size="20"
                       value="<?php echo sanitize_text_field( $publisher ); ?>"/>
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_pub_date' ) ) : ?>
            <div class="publication-date">
                ...
                <label class="rcno_book_publication_date"
                       for="rcno_book_pub_date"><?php _e( 'Publication Date', 'rcno-reviews' ) ?></label>
                <input type="text" name="rcno_book_pub_date" id="rcno_book_pub_date" size="20"
                       value="<?php echo sanitize_text_field( $pub_date ); ?>"/>
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_pub_format' ) ) : ?>
            <div class="publication-format">
                ...
                <label class="rcno_book_publication_format"
                       for="rcno_book_pub_format"><?php _e( 'Publication Format', 'rcno-reviews' ) ?></label>
                <input type="text" name="rcno_book_pub_format" id="rcno_book_pub_format" size="20"
                       value="<?php echo sanitize_text_field( $pub_format ); ?>"/>
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_pub_edition' ) ) : ?>
            <div class="publication-edition">
                ...
                <label class="rcno_book_publication_edition"
                       for="rcno_book_pub_edition"><?php _e( 'Edition', 'rcno-reviews' ) ?></label>
                <input type="text" name="rcno_book_pub_edition" id="rcno_book_pub_edition" size="20"
                       value="<?php echo sanitize_text_field( $pub_edition ); ?>"/>
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_page_count' ) ) : ?>
            <div class="publication-page-count">
                ...
                <label class="rcno_book_page_count"
                       for="rcno_book_page_count"><?php _e( 'Page Count', 'rcno-reviews' ) ?></label>
                <input type="text" name="rcno_book_page_count" id="rcno_book_page_count" size="20"
                       value="<?php echo sanitize_text_field( $page_count ); ?>"/>
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_gr_id' ) ) : ?>
            <div class="publication-gr-id">
                ...
                <label class="rcno_book_gr_id"
                       for="rcno_book_gr_id"><?php _e( 'GoodReads ID', 'rcno-reviews' ) ?></label>
                <input type="text" name="rcno_book_gr_id" id="rcno_book_gr_id" size="20"
                       value="<?php echo sanitize_text_field( $gr_id ); ?>"/>
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_isbn13' ) ) : ?>
            <div class="publication-isbn13">
                ...
                <input type="text" name="rcno_book_isbn13" id="rcno_book_isbn13" size="20"
                       value="<?php echo sanitize_text_field( $isbn13 ); ?>"/>
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_asin' ) ) : ?>
            <div class="publication-asin">
                ...
                <input type="text" name="rcno_book_asin" id="rcno_book_asin" size="20"
                       value="<?php echo sanitize_text_field( $asin ); ?>"/>
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_gr_rating' ) ) : ?>
            <div class="publication-gr-review">
                ...
                <label class="rcno_book_gr_review"
                       for="rcno_book_gr_review"><?php _e( 'Average', 'rcno-reviews' ) ?></label>
                <input type="text" name="rcno_book_gr_review" id="rcno_book_gr_review" size="20"
                       value="<?php echo sanitize_text_field( $gr_review ); ?>"/>
		...
		<?php if ( true === (bool) Rcno_Reviews_Option::get_option( 'rcno_show_gr_url' ) ) : ?>
            <div class="publication-gr-url">
                ...
                <label class="rcno_book_gr_url"
                       for="rcno_book_gr_url"><?php _e( 'GoodReads URL', 'rcno-reviews' ) ?></label>
                <input type="text" name="rcno_book_gr_url" id="rcno_book_gr_url" size="20"
                       value="<?php echo sanitize_text_field( $gr_url ); ?>"/>

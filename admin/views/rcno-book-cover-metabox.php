<?php { ?>
	...
	<input type="hidden" id="rcno-reviews-book-cover-src" name="rcno_reviews_book_cover_src" value="<?php echo $cover_src; ?>" />
    <input type="hidden" id="rcno-reviews-book-cover-alt" name="rcno_reviews_book_cover_alt" value="<?php echo $cover_alt; ?>" />
	<input type="hidden" id="rcno-reviews-book-cover-title" name="rcno_reviews_book_cover_title" value="<?php echo $cover_title; ?>" />

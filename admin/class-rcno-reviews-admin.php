...
SQL;
	 ...
	 */
	public function rcno_update_message_warning( $plugin_data, $r ) {

		// Get README contents
		//$data = file_get_contents( 'https://plugins.trac.wordpress.org/browser/recencio-book-reviews/trunk/README.txt?format=txt' );
		$response = wp_remote_get( 'https://plugins.trac.wordpress.org/browser/recencio-book-reviews/trunk/README.txt?format=txt' );
		...
		//$curr_ver = get_plugin_data( RCNO_PLUGIN_FILE, 'Version' );
